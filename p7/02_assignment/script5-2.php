...
<head>
    ...
    */
    ...
    $pajak = 0.15 * $gajiKotor; // hitting pajak |
    $gajibersih = $gajiPokok + $tunjangan - $pajak; // hitting gaji bersih |
    echo "<p>Gaji bersih karyawan adalah Rp. ".$gajibersih."</p>"; // menampilkan gaji bersih |
    // CARA KE - 2    |
    $gajiPokok = 1000000; // gaji pokok    |
    $tunjangan = 5000000; // tunjangan    |
    $gajiKotor = $gajiPokok + $tunjangan; // hitting gaji kotor    |
    $gajibersih = $gajiKotor - (0.15 * $gajiKotor); // hitting gaji bersih |
    echo "<p>Gaji bersih karyawan adalah Rp. ".$gajibersih."</p>"; // menampilkan gaji bersih |
    // CARA KE - 3    |
    $gajiPokok = 1000000; // gaji pokok    |
    $tunjangan = 5000000; // tunjangan    |
    $gajibersih = $gajiPokok + $tunjangan - 0.15 * ($gajiPokok +    
    $tunjangan); // hitting gaji bersih    |
    echo "<p>Gaji bersih karyawan adalah Rp. ".$gajibersih."</p>"; // menampilkan gaji bersih |
    ?>    
</body>
</html>
